...
export default function LocationPage() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Section Photo Galerie - Plus compacte */}
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">

          {/* Grid masonry photos de localisation */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
            {/* Grande photo vallée */}
            <div className="col-span-2 row-span-2 relative h-[280px] sm:h-[350px] md:h-[400px] rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
              <Image
                src="/images/entre2vallees.webp"
              ...
              <div className="absolute bottom-4 left-4 text-white">
                <h3 className="text-lg md:text-xl font-bold mb-1">
                  {t({ en: 'Between Valleys', fr: 'Entre Vallées' })}
                </h3>
                <p className="text-sm text-white/90">🏔️ {t({ en: 'Arve & Giffre', fr: 'Arve & Giffre' })}</p>
              </div>
            </div>

            {/* Chalet extérieur */}
            <div className="relative h-[135px] sm:h-[170px] md:h-[195px] rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
              <Image
              ...
              <div className="absolute bottom-2 left-2 text-white">
                <p className="text-xs md:text-sm font-semibold">☀️ {t({ en: 'Summer', fr: 'Été' })}</p>
              </div>
            </div>
            ...
            <div className="relative h-[135px] sm:h-[170px] md:h-[195px] rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
              <div className="absolute bottom-2 left-2 text-white">
                <p className="text-xs md:text-sm font-semibold">❄️ {t({ en: 'Winter', fr: 'Hiver' })}</p>
              </div>
            </div>
            ...
            <div className="relative h-[135px] sm:h-[170px] md:h-[195px] rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
              <Image
                src="/images/ChaletPAnoramiqueVueHaut.webp"
                alt="Vue panoramique"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 50vw, 25vw"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
              <div className="absolute bottom-2 left-2 text-white">
                <p className="text-xs md:text-sm font-semibold">📍 732m</p>
              </div>
            </div>
            ...
            <div className="relative h-[135px] sm:h-[170px] md:h-[195px] rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
              <div className="absolute bottom-2 left-2 text-white">
                <p className="text-xs md:text-sm font-semibold">🌄 {t({ en: 'Views', fr: 'Vues' })}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <div className="bg-gray-100 px-4 py-2 rounded-full border border-gray-200">
              <span className="text-sm md:text-base font-semibold text-gray-700">📍 {location.village}</span>
            </div>
            <div className="bg-gray-100 px-4 py-2 rounded-full border border-gray-200">
              <span className="text-sm md:text-base font-semibold text-gray-700">⛰️ 732m</span>
            </div>
            <div className="bg-gray-100 px-4 py-2 rounded-full border border-gray-200">
              <span className="text-sm md:text-base font-semibold text-gray-700">🏔️ {t({ en: '2 valleys', fr: '2 vallées' })}</span>
            </div>
          </div>
        </div>
      </section>
