      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-200 text-base leading-relaxed mb-8 font-medium">
              {t({
            ...
            <div className="flex items-start space-x-3 text-gray-200 text-base">
              ...
              <div>
                ...
                <div className="font-medium text-gray-200">{location.region}, {location.postalCode}</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/chalet" className="text-gray-300 hover:text-white transition-colors flex items-center group text-sm font-medium">
              ...
              <li>
                <Link href="/location" className="text-gray-300 hover:text-white transition-colors flex items-center group text-sm font-medium">
                  <span className="w-1.5 h-1.5 bg-gold-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                  {t({ en: 'Location', fr: 'Localisation' })}
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="text-gray-300 hover:text-white transition-colors flex items-center group text-sm font-medium">
                  <span className="w-1.5 h-1.5 bg-gold-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/booking" className="text-gray-300 hover:text-white transition-colors flex items-center group text-sm font-medium">
                  <span className="w-1.5 h-1.5 bg-gold-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                  {t({ en: 'Rates & Booking', fr: 'Tarifs & Réservation' })}
                </Link>
              </li>
              <li>
                <Link href="/guide" className="text-gray-300 hover:text-white transition-colors flex items-center group text-sm font-medium">
                  <span className="w-1.5 h-1.5 bg-gold-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-4">
              <a href="mailto:info@chaletlessires.com" className="flex items-start space-x-3 text-gray-300 hover:text-white transition-colors group">
                ...
                <div>
                  <div className="text-xs uppercase tracking-wide text-gray-400 mb-1 font-medium">{t({ en: 'Email', fr: 'Email' })}</div>
